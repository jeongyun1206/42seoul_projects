...
/*   Updated: 2022/12/23 14:47:55 by jnho             ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void	checker_stack_cmd_pa(t_ps_stack *ps_stack);
void	checker_stack_cmd_pb(t_ps_stack *ps_stack);
...
void	checker_stack_cmd_ra(t_ps_stack *ps_stack);
void	checker_stack_cmd_rb(t_ps_stack *ps_stack);
void	checker_stack_cmd_rr(t_ps_stack *ps_stack);
